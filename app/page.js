...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // Always fetch locations whether the user is logged in or not
    fetchLocations()
  }, [])
  ...
  // Authentication removed: app now works without login/signup pages
      ...
      <header className="border-b bg-white/95 backdrop-blur sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">BusNavigator</h1>
